...
output_folder = os.getcwd() + '/Crypt/scripts/'
script_folder = os.getcwd() + '/Crypt/scripts/'
with h5py.File(''.join([script_folder + 'bitcoin2015to2017_close.h5']), 'r') as hf:
    datas = hf['inputs'].value
    labels = hf['outputs'].value

output_file_name = output_folder + 'bitcoin2015to2017_close_CNN_2_relu'
